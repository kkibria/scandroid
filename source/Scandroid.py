...
# BUSTED AGAIN, NOW ON READ! WORKS FINE IN WING; BUT AS AN APP:
# THE VERSION IN THE NEXT LINES DOESN'T DISPLAY THE FILE **AT ALL**
# THE COMMENTED-OUT READS UP TO THE LINE CONTAINING AN ACCENT
            #print "\ndefault encoding is " + defaultEncoding + "\n"
            data = f.read()
